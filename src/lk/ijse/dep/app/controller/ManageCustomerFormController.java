...
import lk.ijse.dep.app.business.ManageCustomersBusiness;
...
public class ManageCustomerFormController{
    ...
    public void initialize() throws SQLException {
        ...
        List<CustomerDTO> customersDB = ManageCustomersBusiness.getCustomers();
    ...
    private void btnSave_OnAction(ActionEvent event) throws SQLException {
        ...
        if (tblCustomers.getSelectionModel().isEmpty()) {
            ...
            boolean result = ManageCustomersBusiness.createCustomer(customerDTO);
            ...
            boolean result = ManageCustomersBusiness.updateCustomer(new CustomerDTO(txtCustomerId.getText(),
    ...
    private void btnDelete_OnAction(ActionEvent event) throws SQLException {
        ...
        if (buttonType.get() == ButtonType.YES) {
            ...
            boolean result = ManageCustomersBusiness.deleteCustomer(selectedCustomer);
            if (!result){
